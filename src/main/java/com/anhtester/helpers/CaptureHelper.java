...
public class CaptureHelper extends ScreenRecorder{
    ...
    //Tạo format ngày giờ để vào cái name của screenshot hoặc record video không bị trùng tên (không bị ghi đè file)
    ...
    public static void takeScreenshoot(String screenshootName) {
        ...
        try {
            FileHandler.copy(
                    source,
                    new File(SystemHelper.getCurrentDirectory() + PropertiesHelper.getValue("SCREENSHOT_PATH") + screenshootName + ".png"));
